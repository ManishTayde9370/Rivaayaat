...
const BrandStory = () => (
  <div className="container py-5">
    ...
    <blockquote className="blockquote">
      <p>“Rivaayaat is a tribute to the timeless beauty of Indian tradition. Our journey is about connecting artisans and customers, and keeping heritage alive in every home.”</p>
      <footer className="blockquote-footer">Manish Sharma, Founder</footer>
    </blockquote>
    <h4 className="mt-5">Our Journey</h4>
    <ul className="timeline list-unstyled">
      <li><strong>2018:</strong> Rivaayaat founded in Mumbai with a vision to celebrate Indian crafts.</li>
