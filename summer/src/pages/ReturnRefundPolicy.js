...
const ReturnRefundPolicy = () => (
  <div className="container py-5">
    <h1 className="mb-4 rivaayat-heading">Return & Refund Policy</h1>
    <ol style={{ maxWidth: 700, background: '#fff8f0', borderRadius: 12, border: '1.5px solid var(--border-color)', padding: 24 }}>
      ...
      <li><strong>Initiate Return:</strong> Email care@rivaayaat.com or use the Track Order page to request a return. Provide your order ID and reason.</li>
    ...
    <p>For any questions, contact our support team at care@rivaayaat.com.</p>
  </div>
);
